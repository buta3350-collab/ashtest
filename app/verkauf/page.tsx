...
export default function VerkaufPage() {
  ...
  function goToPage(p: number) {
    setPage(p)
    document.querySelector('.verkauf-section')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
  }
    ...
    <>
      ...
      <nav id="vk-nav">
        ...
        <div className="vk-nav-right">
          <Image className="vk-nav-logo" src="/LOGO_crop.png" alt="Auto Shabani" width={160} height={54} style={{ height: 54, width: 'auto' }} />
          <ModeToggle />
        </div>
      </nav>

      <div className="vk-page-shell">
      <header id="verkauf-header">
        <div className="vk-header-inner">
          <div className="vk-header-eyebrow">Autocenter — Bundesweit</div>
          <h1 className="vk-header-h1">Fahrzeug<br /><em>angebot</em></h1>
          <p className="vk-header-sub">Aktuelle Gebrauchtwagen aus unserem Bestand in Wolfsberg. Geprüfte Qualität, faire Preise, persönliche Beratung.</p>
        </div>
      </header>
      ...
      <footer className="verkauf-footer">
        <div className="vk-footer-top">
          <div className="vk-footer-col">
            <h5>Kontakt</h5>
            <ul>
              <li><a href="tel:+436641060411">+43 664 1060411</a></li>
              <li><a href="mailto:autocenter.shabani@gmail.com">autocenter.shabani@gmail.com</a></li>
              <li>Drosselweg 1, 9400 Wolfsberg</li>
            </ul>
          </div>
          <div className="vk-footer-col">
            <h5>Öffnungszeiten</h5>
            <ul>
              <li><strong>Mo – Fr</strong> 08:00 – 19:00</li>
              <li><strong>Samstag</strong> 08:00 – 14:00</li>
          ...
          <div className="vk-footer-col">
            ...
            <ul>
              ...
              <li><a href="/#services">Fahrzeugpflege</a></li>
              <li><a href="/#about">Über uns</a></li>
            </ul>
          </div>
        </div>
        <div className="vk-footer-disclaimer">
          Alle Markenzeichen und Logos sind Eigentum der jeweiligen Hersteller und werden ausschließlich zur Produktidentifikation verwendet. Autocenter Shabani ist ein unabhängiger Fahrzeugvermittler und steht in keiner geschäftlichen Verbindung zu den genannten Herstellern.
        </div>
        <div className="vk-footer-bottom">
          <p>© 2025 Autoreinigung &amp; Autocenter Shabani · Wolfsberg · Alle Rechte vorbehalten</p>
...
function ModeToggle() {
  ...
  function toggle() {
    ...
    localStorage.setItem('shabani-modus', next ? 'light' : 'dark')
    setLight(next)
  }

  return (
    <button id="mode-toggle" aria-label="Darstellung wechseln" onClick={toggle}>
      <svg className={light ? 'icon-sun' : 'icon-moon'} style={{ display: 'block' }} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        {light ? (
          <>
